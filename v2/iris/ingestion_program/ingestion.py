...
def get_training_data():
    X_train = np.genfromtxt(os.path.join(input_dir, 'train.data'))
    y_train = np.genfromtxt(os.path.join(input_dir, 'train.solution'))
    return X_train, y_train


def get_prediction_data():
    return np.genfromtxt(os.path.join(input_dir, 'test.data'))
